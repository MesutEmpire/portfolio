<template>
  <div class="t-4 md:pt-8 pb-2 bg-white dark:bg-background fixed top-0 w-full z-[999]">
    ...
    />
    <div
      class="fixed lg:flex items-center flex-col justify-center left-4 gap-2 top-0" :class="{'flex -translate-y-[100%] -translate-x-[50%] z-[9999] left-[50%] mytop text-[24px]':showNavbar,'hidden':!showNavbar}"
    >
    ...
    <div class=" my-0 p-4 lg:p-0 mx-auto max-w-5xl relative" :class="{'w-full h-[100vh]':showNavbar}" >
      <div class="flex w-full justify-between align-center gap-4 relative" :class="{'items-start':showNavbar}">
